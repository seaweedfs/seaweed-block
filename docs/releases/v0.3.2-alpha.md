...
Phase 27 QA used locally built TestOps images. For externally consumable
immutable GHCR image guidance, use the current validated alpha release note:
[v0.3.4-alpha.md](v0.3.4-alpha.md).
