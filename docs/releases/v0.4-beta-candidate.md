...
| Phase 40 D1-D6 operator production hardening | `current-plan.md`, `phase40-d4-status-api-conformance-qa.md`, `phase40-d6-release-candidate-qa.md`, `phase40-d6-release-candidate-qa-signoff.md` | PASS |
...
Use immutable tags for release validation:
...
Seaweed Block v0.4 beta may claim:
