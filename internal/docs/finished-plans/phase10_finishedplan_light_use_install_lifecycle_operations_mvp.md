...
Formal QA close report:
`internal/docs/qa-assignments/light-use-mvp-close-report.md`.
...
- Happy path: `20260511-200544-dca5`.
- Failure bundle: `20260511-203619-885f`.
- Retry/idempotency: `20260511-204348-ccc4`.
- Break classes: `20260511-210727-5cb9`.
