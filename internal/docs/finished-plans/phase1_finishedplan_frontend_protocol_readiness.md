# Finished Plan: iSCSI/NVMe Frontend Protocol Readiness

Status: historical reference. Closed on 2026-05-09 by the runner-native
protocol release gate.

This phase/topic file preserves the plan that brought iSCSI and NVMe from active
frontend bring-up to release-gated protocol coverage. It is no longer the active
execution plan. Current work is tracked in `../current-plan.md`.
