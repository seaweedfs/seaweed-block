...
summary = [
    ...
    f"final_sync_ns={plain['final_sync_ns']}",
    f"final_drain_ns={plain['final_drain_ns']}",
    ...
    f"wal_append_ops={plain['wal_append_ops']}",
    f"wal_append_ns={plain['wal_append_ns']}",
    f"wal_append_lock_wait_ns={plain['wal_append_lock_wait_ns']}",
    f"commit_lock_wait_ops={plain['commit_lock_wait_ops']}",
    f"commit_lock_wait_ns={plain['commit_lock_wait_ns']}",
    f"dirty_map_update_ops={plain['dirty_map_update_ops']}",
    f"dirty_map_update_ns={plain['dirty_map_update_ns']}",
