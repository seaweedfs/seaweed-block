...
TARGET_WRITE_REQUEST_MAX_BYTES="$(require_summary_value "${BLOCK_SUMMARY}" target_write_request_max_bytes)"
TARGET_WRITE_REQUEST_AVG_BYTES="$(require_summary_value "${BLOCK_SUMMARY}" target_write_request_avg_bytes)"
TARGET_MS="$(require_summary_value "${BLOCK_SUMMARY}" target_write_duration_ms)"
BACKEND_WRITE_REQUEST_OPS="$(require_summary_value "${BLOCK_SUMMARY}" backend_write_request_ops)"
BACKEND_WRITE_REQUEST_BYTES="$(require_summary_value "${BLOCK_SUMMARY}" backend_write_request_bytes)"
BACKEND_WRITE_REQUEST_MAX_BYTES="$(require_summary_value "${BLOCK_SUMMARY}" backend_write_request_max_bytes)"
BACKEND_WRITE_REQUEST_AVG_BYTES="$(require_summary_value "${BLOCK_SUMMARY}" backend_write_request_avg_bytes)"
...
BACKEND_FULL_BLOCK_BATCH_CALLS="$(require_summary_value "${BLOCK_SUMMARY}" backend_full_block_batch_calls)"
BACKEND_FULL_BLOCK_BATCH_BLOCKS="$(require_summary_value "${BLOCK_SUMMARY}" backend_full_block_batch_blocks)"
BACKEND_FULL_BLOCK_BATCH_MAX="$(require_summary_value "${BLOCK_SUMMARY}" backend_full_block_batch_max)"
BACKEND_FULL_BLOCK_BATCH_AVG="$(require_summary_value "${BLOCK_SUMMARY}" backend_full_block_batch_avg)"
...
WAL_APPEND_WRITEAT_CALLS="$(require_summary_value "${BLOCK_SUMMARY}" wal_append_writeat_calls)"
WAL_APPEND_WRITEAT_BYTES="$(require_summary_value "${BLOCK_SUMMARY}" wal_append_writeat_bytes)"
WAL_APPEND_WRITEAT_MAX_BYTES="$(require_summary_value "${BLOCK_SUMMARY}" wal_append_writeat_max_bytes)"
WAL_APPEND_WRITEAT_AVG_BYTES="$(require_summary_value "${BLOCK_SUMMARY}" wal_append_writeat_avg_bytes)"
WAL_APPEND_WRAP_COUNT="$(require_summary_value "${BLOCK_SUMMARY}" wal_append_wrap_count)"
WAL_APPEND_PADDING_BYTES="$(require_summary_value "${BLOCK_SUMMARY}" wal_append_padding_bytes)"
...
assert_int_ge "${BACKEND_WRITE_REQUEST_OPS}" 1 "backend_write_request_ops"
assert_int_ge "${BACKEND_WRITE_REQUEST_BYTES}" "${SEQ_BYTES}" "backend_write_request_bytes"
...
assert_int_ge "${BACKEND_FULL_BLOCK_BATCH_CALLS}" 1 "backend_full_block_batch_calls"
...
write_summary "target_write_request_avg_bytes=${TARGET_WRITE_REQUEST_AVG_BYTES}"
write_summary "target_write_duration_ms=${TARGET_MS}"
write_summary "backend_write_request_ops=${BACKEND_WRITE_REQUEST_OPS}"
write_summary "backend_write_request_bytes=${BACKEND_WRITE_REQUEST_BYTES}"
write_summary "backend_write_request_max_bytes=${BACKEND_WRITE_REQUEST_MAX_BYTES}"
write_summary "backend_write_request_avg_bytes=${BACKEND_WRITE_REQUEST_AVG_BYTES}"
...
write_summary "backend_full_block_batch_calls=${BACKEND_FULL_BLOCK_BATCH_CALLS}"
...
write_summary "backend_full_block_batch_avg=${BACKEND_FULL_BLOCK_BATCH_AVG}"
