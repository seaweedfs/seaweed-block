...
**Fast path: use published alpha images**
...
To install the alpha stack and use your own PVC/app instead of the bundled demo:
...
workload generated by blockmaster until a real operator owns that reconciliation.
